//unordered multimap can contain duplicate values
// values cannot be accessed randomly in multimaps (i.e) using [] and at() functions
#include<bits/stdc++.h>
using namespace std;

void display(unordered_multimap<char,int> &mp){
    int ct=0;
    for(auto p : mp){
